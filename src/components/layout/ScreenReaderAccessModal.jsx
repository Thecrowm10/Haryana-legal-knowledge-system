    ...
    >
      <style>{`
        @media (max-width: 560px) {
          .sr-modal-header, .sr-modal-pad { padding-left: 16px !important; padding-right: 16px !important; }
        }
      `}</style>
      <div
      ...
      >
        ...
        <div className="sr-modal-header" style={{ padding: '20px 24px', borderBottom: '1px solid var(--surface-border)', display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        <div style={{ overflowY: 'auto' }}>
          ...
          <div className="sr-modal-pad" style={{ padding: '20px 24px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
          ...
          <div className="sr-modal-pad" style={{ padding: '0 24px 20px' }}>
            <div style={{ ...LABEL, marginBottom: 10 }}>Compatible Screen Readers</div>
            {/* Horizontally scrollable on narrow screens so columns keep readable widths
                instead of squeezing 4 columns + a no-wrap button into the viewport. */}
            <div style={{ border: '1px solid var(--surface-border)', borderRadius: 10, overflow: 'auto', WebkitOverflowScrolling: 'touch' }}>
          ...
          <div className="sr-modal-pad" style={{ padding: '18px 24px 20px', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
