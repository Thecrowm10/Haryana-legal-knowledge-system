const STYLES = {
  approved: { bg: 'rgba(34,197,94,.1)',   color: '#1e40af', border: 'rgba(34,197,94,.25)' },
  ...
  citizen:  { bg: 'rgba(26,86,219,.1)',   color: '#1a56db', border: 'rgba(26,86,219,.25)' },
  ...
  csoffice: { bg: 'rgba(34,197,94,.1)',   color: '#1e40af', border: 'rgba(34,197,94,.25)' },
};
