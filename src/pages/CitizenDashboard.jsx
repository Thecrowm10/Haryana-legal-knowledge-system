...
// Maps a public search result row into the shape DocViewModal expects — same
// field names the authenticated dashboards read (mapApiDoc/mapDocForViewer),
// so every filled-in field from upload shows up here too, not just the
// filename. Deliberately omits uploader identity and internal approval/review
// details — those are internal workflow info, not for public display.
function mapPublicDocForViewer(d) {
  return {
    id:              d.id,
